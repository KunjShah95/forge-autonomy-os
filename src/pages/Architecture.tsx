  ...
  return (
    <div className="space-y-6">
      ...
      <Panel eyebrow="topology" title="Microservice Dependency Graph" className="h-[520px]"
        actions={<span className="mono text-[10px] text-muted-foreground">hover any node</span>}>
        <ServiceGraph height={460} />
      </Panel>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Panel eyebrow="hotspots" title="Bottleneck Detection" className="lg:col-span-1">
